    ...
    <div class="search-section">
        <div class="search-content">
            ...
            <div class="search-results-info">
                Found <strong><%= customerList.size() %>
            </strong> customer(s) for <strong><%= searchTerm %>
            </strong>
            </div>
            <% } %>
        </div>
    ...
    <div class="table-section">
        ...
        <table class="compact-table">
            ...
            <tr>
                ...
                <td><%= customer.getDob() != null ? customer.getDob() : "" %>
                </td>
                <td><%= escAddress %>
                </td>
                <td><%= escStatus %>
                </td>
                <td><%= customer.getRegisteredDate() != null ? customer.getRegisteredDate().toString().substring(0, 16) : "" %>
                </td>
                <td>
